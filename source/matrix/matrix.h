...
extern uint32_t MATRIX[VIRTUAL_MAX_ROW];

extern uint32_t curMATRIX[VIRTUAL_MAX_ROW];
extern int8_t debounceMATRIX[VIRTUAL_MAX_ROW][VIRTUAL_MAX_COL];
extern uint8_t  currentLayer[VIRTUAL_MAX_ROW][VIRTUAL_MAX_COL];
