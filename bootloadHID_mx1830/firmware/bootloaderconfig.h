...
static inline void  bootLoaderInit(void)
{
    ...
    DDRA  &= ~(1 << PINA0);      // PINA0(row0) input
    PORTA |= (1 << PINA0);      // PINA0(pullUP)

//M3
//    DDRC  |= (1 << PINBC);      // PINB0(column0) output
//    PORTC &= ~(1 << PINBC);     // pull low
